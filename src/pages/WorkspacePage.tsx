...
export function WorkspacePage() {
  ...
  return (
    ...
    {state.screen === 'settings' && <div className="settings-host" data-theme={theme} data-reduced-motion={state.preferences.reducedMotion} style={themeVariables(customTheme)}><SettingsPage /></div>}
    </>
  )
}
